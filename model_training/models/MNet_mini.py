...
class Encoder(nn.Module):
    def __init__(self, in_dim=3, out_dim=64):
        ...
        self.c4 = nn.Conv2d( 32, out_dim, 3, 1, 1)
    ...
    def forward(self, input):
        ...
        output= self.pool4(h4)
        # print('output shape:',output.shape)
        return (output,h4, h3, h2)    

class Decoder(nn.Module):
    def __init__(self, out_dim=2, in_dim=64):
        super(Decoder, self).__init__()
        self.conv1 = conv(in_dim, 64)
        self.upc1 = upconv(64, 32)#skip
        self.conv2 = conv(32, 32)
        self.upc2 = upconv(64+32, 16)
        self.conv3 = conv(16, 16)
        self.upc3=upconv(32+16,4)
    ...
    def forward(self, vals):
        ...
        # print('h3 shape:',vals[1].shape)
        # print('h4 shape:',vals[0].shape)
        # print('h2 shape:',vals[2].shape)
        ...
        output = self.conv4(d4)  # shortpath from 2->7#4,1
