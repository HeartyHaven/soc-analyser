...
class Encoder(nn.Module):
    def __init__(self, in_dim=3, out_dim=256):
        ...
        self.c6 = nn.Conv2d( 128, out_dim, 3, 1, 1)
    ...
    def forward(self, input):
        ...
        h6=self.pool5(h5)
        h6=self.c6(h6)
        output= self.pool6(h6)
        # print('output shape:',output.shape)
        return (output,h6,h5,h4,h3,h2)    

class Decoder(nn.Module):
    def __init__(self, out_dim=2, in_dim=256):
        super(Decoder, self).__init__()
        self.conv1 = conv(in_dim, 256)
        self.upc1 = upconv(256, 128)#skip
        self.conv2 = conv(128, 128)
        self.upc2 = upconv(128+256, 64)
        self.conv3 = conv(64, 64)
        self.upc3=upconv(64+128,32)
        self.conv4 = conv(32, 32)
        self.upc4=upconv(64+32,16)
        self.conv5 = conv(16, 16)
        self.upc5=upconv(32+16,4)
    ...
    def forward(self, vals):
        ...
        d6=self.upc5(torch.cat((d5,vals[4]),dim=1))
        output=self.conv6(d6)  # shortpath from 2->7#4,1
